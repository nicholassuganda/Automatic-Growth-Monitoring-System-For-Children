...
<head>
  ...
  <title>BINUS ASO Clinic Center - Data Dokter</title>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="home.php">Dokter <?php echo $_SESSION['username']; ?></a></h1>
      </div>
...
<section class="section-table cid-shhgQXrNMq" id="table1-6">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">DOCTOR DATA</h2>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0" data-empty="No matching records found">
            <thead>
			  ...
			  <th class="head-item mbr-fonts-style display-5">SPECIALIST</th>
			  <th class="head-item mbr-fonts-style display-5">CONTACT</th>
			  </tr>
            </thead>
...
?>			
            <tr> 
			  ...
			  <td class="body-item mbr-fonts-style display-5"><?php echo $row["namadokter"];?></td>
			  <td class="body-item mbr-fonts-style display-5"><?php echo $row["spesialis"];?></td>
			  <td class="body-item mbr-fonts-style display-5">+<?php echo $row["hp"];?></td>
